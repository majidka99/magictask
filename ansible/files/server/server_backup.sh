...
ADDRESS='admin@majitask.fun'  # Update with your email
ADDRESS_ALERT="admin@majitask.fun"  # Update with your email
...
echo "From: majitask@majitask.fun" > $LOG
echo "To: $ADDRESS" >> $LOG
...
cat $LOG | /usr/sbin/sendmail -f passbolt@prazskacokolada.cz $ADDRESS
